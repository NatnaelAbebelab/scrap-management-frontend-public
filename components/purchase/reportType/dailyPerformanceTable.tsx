...
export function DailyPerformanceTable({ filterCriteria, reportRecord}: DailyPerformanceReportTableProps) {
        ...
        <table className="w-full min-w-[1200px] caption-bottom text-sm">
          <thead className="sticky top-0 bg-background">
            <tr className="border-b transition-colors hover:bg-muted/50">
              ...
              <th className="h-12 px-4 text-left align-middle font-medium min-w-[250px]">GRN No</th>
              <th className="h-12 px-4 text-left align-middle font-medium min-w-[150px]">Material Type</th>
              <th className="h-12 px-4 text-left align-middle font-medium min-w-[150px]">Heavy Weight</th>
              <th className="h-12 px-4 text-left align-middle font-medium min-w-[150px]">Medium Weight</th>
              <th className="h-12 px-4 text-left align-middle font-medium min-w-[150px]">Light Weight</th>
              <th className="h-12 px-4 text-left align-middle font-medium min-w-[150px]">Net Weight</th>
                ...
                className={`border-b transition-colors hover:bg-muted/50 ${
                  ...
                  <td className="p-4 align-middle">
                    <div className="text-sm p-2 bg-muted rounded-md">
                      <p className="font-medium">Customer Name: {record?.customer}</p>
